...
label2name = {}
label2token = {}
with open(f"D:/mymodel/truedataset/final/retrieve/documents.txt") as fin:
...
with open(f"D:/mymodel/truedataset/final/retrieve/node_retrieval.jsonl") as fin, \
	 open(f'D:/mymodel/truedataset/final/rank/node_reranking.jsonl', 'w') as fout:
	readin = fin.readlines()
	for line in tqdm(readin):
		data = json.loads(line)
		text = data['x1'][0].strip()
		...
		#print(text)
		#print(candidates)
		print(match_neg_candidates)
		fout.write(json.dumps(data)+'\n')

#import error
# split the whole data into train/val/test in 8:1:1.

with open(f'D:/mymodel/truedataset/final/rank/node_reranking.jsonl') as f,  \
	open(f'D:/mymodel/truedataset/final/rank/train.rerank.text.jsonl', 'w') as fout1, \
		open(f'D:/mymodel/truedataset/final/rank/val.rerank.text.jsonl', 'w') as fout2, \
			open(f'D:/mymodel/truedataset/final/rank/test.rerank.text.jsonl', 'w') as fout3:
    readin = f.readlines()
