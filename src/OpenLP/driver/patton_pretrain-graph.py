...
from OpenLP.dataset import TrainLMCollator, TrainGraphDataset, EvalDataset
...
def main():
    ...
    train_dataset = TrainGraphDataset(tokenizer, data_args, shuffle_seed=training_args.seed, cache_dir=data_args.data_cache_dir or model_args.cache_dir)
